...
import KTHubLogo from "./KTHubLogo";
...
export default function Sidebar() {
  ...
  const visible = navItems.filter(
    (i) => hierarchy[user.role_type] >= hierarchy[i.minRole],
  );
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-logo">
        <KTHubLogo transparent  size={38} />
        <div className="sidebar-logo-text">
          <span className="sidebar-logo-title">KTHub</span>
          <span className="sidebar-logo-sub">TATA InFuzzE · POC</span>
        </div>
      </div>

      <div className="sidebar-greeting">
        Hey, {firstName} <span className="sidebar-wave">👋</span>
      </div>
      ...
      <div className="sidebar-footer">
        <div className="sidebar-user">
          ...
          <div className="sidebar-user-info">
            ...
            <span
              className={`pill role-pill role-${roleColor[user.role_type]}`}
            >
